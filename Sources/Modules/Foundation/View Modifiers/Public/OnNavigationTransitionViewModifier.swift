...
private struct TransitionDurationReader: UIViewControllerRepresentable {
    ...
    func updateUIViewController(
        _ uiViewController: TransitionTrackingViewController,
        context: Context
    ) {}
}
...
private final class TransitionTrackingViewController: UIViewController {
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        transitionCoordinator.animate(alongsideTransition: nil) { _ in
            self.onViewWillDisappear?(.seconds(
                transitionCoordinator.transitionDuration
            ))
        }
    }
    ...
    override func viewDidDisappear(_ animated: Bool) {
        ...
        transitionCoordinator.animate(alongsideTransition: nil) { _ in
            self.onViewDidDisappear?(.seconds(
                transitionCoordinator.transitionDuration
            ))
        }
    }
