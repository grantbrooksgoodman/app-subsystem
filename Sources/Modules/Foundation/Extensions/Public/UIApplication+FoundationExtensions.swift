...
public extension UIApplication {
    ...
    func presentedViewControllers(_ mainWindowOnly: Bool = false) -> [UIViewController] {
        ...
        for window in windows {
            ...
            viewControllers += [rootViewController]
                + rootViewController.ancestors() as [UIViewController]
    ...
    func presentedViews(_ mainWindowOnly: Bool = false) -> [UIView] {
        ...
        let windowAttachedViews = windows.flatMap { [$0] + $0.traversedSubviews }

        let viewControllerViews = viewControllers.compactMap(\.view)
