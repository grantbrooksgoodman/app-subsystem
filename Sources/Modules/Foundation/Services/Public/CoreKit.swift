...
public struct CoreKit {
    ...
    public final class HUD {
        ...
        private var interactableViews: [UIView]?
        ...
        public func hide(after delay: Duration? = nil) {
            mainQueue.async {
                ...
                func hideHUD() {
                    self.interactableViews?.forEach { $0.isUserInteractionEnabled = true }
                    self.interactableViews = nil
        ...
        public func showProgress(
            ...
            mainQueue.async {
                func showHUD() {
                    ...
                    self.interactableViews = self.uiApplication.presentedViews.filter(\.isUserInteractionEnabled)
                    self.interactableViews?.forEach { $0.isUserInteractionEnabled = false }
                }
